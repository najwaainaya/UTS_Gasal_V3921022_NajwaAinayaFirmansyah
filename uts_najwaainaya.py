...
key = int(input('Input cipher key (dalam angka): '))
...
print('Langkah 1 Caesar Chiper')
print('========================')
kalimat = input('Input Teks : ')
...
print('Langkah 2 Affine Chiper')
print('=======================')
if __name__ == "__main__": 
  string = "cemmocscxydpsxkvpksveboscxydpkdkvsdscdromyebkqodymyxdsxeodrkdmyexdc"
  keyword = "NAJWA"
